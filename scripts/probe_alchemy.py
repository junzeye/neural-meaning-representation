...
parser.add_argument('--arch', type=str, default='bart', choices=['t5', 'bart', 'bert', 'mbart', 'mt5'])
parser.add_argument('--encode_tgt_state', type=str, default=False, choices=[False, 'raw.mlp', 'NL.bart', 'NL.t5', 'NL.mbart', 'NL.mt5'], help="how to encode the state before probing")
